...
Specify the Vue Stitch sprint calculator page behavior, including interactive inputs, recalculation flow, output rendering, and validation feedback behavior.
